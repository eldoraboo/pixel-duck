...
declare const TextInputWithTokens: React.ForwardRefExoticComponent<{
     ...
     * The array of tokens to render
     */
    tokens: any[] | (Omit<(Pick<React.DetailedHTMLProps<React.ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement>, "key" | keyof React.ButtonHTMLAttributes<HTMLButtonElement>> & {
