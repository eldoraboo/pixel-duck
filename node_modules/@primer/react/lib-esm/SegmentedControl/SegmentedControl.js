...
const Root = ({
  ...
  const selectedSegments = React__default.Children.toArray(children).map(child => /*#__PURE__*/React__default.isValidElement(child) && child.props.selected);
  ...
  React__default.createElement(ActionMenu, null, /*#__PURE__*/React__default.createElement(ActionMenu.Button, {
    leadingIcon: getChildIcon(selectedChild)
  }, getChildText(selectedChild)), /*#__PURE__*/React__default.createElement(ActionMenu.Overlay, null, /*#__PURE__*/React__default.createElement(ActionList, {
